    ...
    <div class="signup__container">
      ...
      <div class="container__child signup__form">
        <form action="#">
          ...
          <div class="form-group flex flex-col mb-4">
            <label class="mb-2" for="passwordRepeat">Repeat Password</label>
            <input
              id="passwordRepeat"
              class="form-control"
              type="password"
...
.signup__thumbnail {
  ...
  flex-wrap: wrap;
  align-items: center;
  background: url(https://cdn.reshift.nl/media/media/thumbnails/640/20200429222518236345838367472/95120111_2947098448701265_2106458485460828160_o.jpg);
